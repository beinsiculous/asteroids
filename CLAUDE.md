...
- Asteroids become **roided-out flexing meatballs** in the same 3 size classes; splitting a big one is a flex-burst into smaller, angrier meatballs. The **angry meatball** is a recurring cross-game character (hazard in Snake's "Hot Dog!", patty-rank enemy in "Burger Invaders").
