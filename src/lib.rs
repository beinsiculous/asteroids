//! Insiculous Asteroids — game crate.
//!
//! The library owns the whole game (`AsteroidsGame` + its `Game` impl) so both
...
pub fn game_config(asset_base: &str) -> GameConfig {
    GameConfig::new("Insiculous Asteroids")
